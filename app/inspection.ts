...
export function inspectionGroups(atlas:Atlas){
 ...
 // unchanged; this inspection explicitly selects its existing skeletal members.
 const skull=concept('FMA46565').filter(id=>atlas.parts.some(p=>p.id===id&&p.system==='skeletal'));
