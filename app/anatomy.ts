...
export type View = 'three-quarter'|'front'|'back'|'side'|'left'|'right'|'superior'|'inferior';
export interface SceneState {productionInjuries?:import("./injurybot-bridge").HostedCaseContext["productionInjuries"];sahFocus?:boolean;sahMode?:boolean;sahVisible?:boolean;fractureMode?:boolean;fractureVisible?:boolean;fractureFocus?:boolean;abrasionMode?:boolean;abrasionVisible?:boolean;shoulderFocus?:boolean;abrasionTurn?:number;inspectorOpen?:boolean;layersOpen?:boolean;inspection?:Inspection|null;hiddenParts?:string[];sourceDetail?:boolean;skullReveal?:number;registrationTest?:boolean;explode:number;visible:SystemId[];selected:string[];isolate:boolean;view:View;rotate:boolean;reset:number;selectionMode?:'anatomy'|'injury'}
